...
<body style="font-family: 'Cinzel', serif;">
       ...
       <div class="container-fluid position-relative">
        <div class="position-absolute top-0 start-50 translate-middle-x" style="font-size: 4em;"> divinidades</div>
        ...
        <hr>
           <div class="position-absolute mt-1 start-50 translate-middle-x">
            <ul class="list-group list-group-flush">                              
                    <?php  
                        for($i = 0; $i<$dioses->num_rows;$i++){
                            $fila = $dioses->fetch_assoc();                            
                    ?>
                    <li id="<?php echo $fila['idpropio'];?>" class="list-group-item">  
                    <h1>
                        <a href="clasico.php?id=<?php echo $fila['idpropio'];?>" style="color: black; text-decoration:none;"> 
                            <?php
                                 echo $fila['nombre'];                           
