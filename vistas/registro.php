...
require_once "./../models/usuario.php";
    session_start();
        ...
        $usuario = new usuario();
       // $registro = $usuario->añadir($_POST[], $nombre, $contraseña);
  ...
  <nav class="navbar navbar-expand-lg navbar-light bg-secondary mx-auto">
    ...
    <div class="b row" style=" height: 60vh; width: 90vh; background-color: white;">
      ...
      <div class="col e" style=""> 
        <form class="p-4" method="post" action="">
          ...
          <div class="mb-3">
            ...
            <input required type="email" class="form-control" name="mail" placeholder="email@example.com">
          </div>
          <div class="mb-3">
          ...
          <button type="submit" class="btn btn-primary" style="margin-left: 30%;">registrarse</button>
            <?php                         
                    if(isset($_POST["mail"],$_POST["nombre"],$_POST["password"])){                
                        $usuario->añadir($_POST["mail"],$_POST["nombre"],$_POST["password"]);  
                        unset($_POST);  
      ...
      <div class="col c" style="background-color: #1f7c9f;">
        ...
        <p class="p2">registrate con nosotros</p>
