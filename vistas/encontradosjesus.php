...
$cris = $cristiano->comprobar($_POST['atri']);
//var_dump($cris[0]['idpropio']);    
?>
...
<body style="font-family: 'Cinzel', serif;">
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-secondary mx-auto">
       ...
       <div class="container-fluid position-relative">
        <div class="position-absolute top-0 start-50 translate-middle-x" style="font-size: 4em;">hallazgos</div>
        ...
        <hr>
           <div class="position-absolute mt-1 start-50 translate-middle-x">
            <ul class="list-group list-group-flush">                              
                    <?php  
                       for($i = 0; $i<count($cris); $i++){                                         
                    ?>
                    <li id="<?php echo $cris[$i]['idgen'];?>" class="list-group-item">  
                    <h1>
                    <a href="cristiano.php?id=<?php echo $cris[$i]['idgen'];?>" style="color: black; text-decoration:none;"> 
                            <?php
                                 echo $cris[$i]['nombre'];                         
