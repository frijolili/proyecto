<?php    
require_once "./../models/diccionario.php";     
session_start();
    $dic = new diccionario();
    $palabras = $dic->mostrarpalabra();
?>
...
<body style="font-family: 'Cinzel', serif;">
       ...
       <div class="container-fluid position-relative">
        <div class="position-absolute top-0 start-50 translate-middle-x" style="font-size: 4em;"> DICCIONARIO</div>
        ...
        <hr>
           <div class="position-absolute mt-1 start-50 translate-middle-x">
            <ul class="list-group list-group-flush">                              
                    <?php  
                        for($i = 0; $i<$palabras->num_rows;$i++){
                            $fila = $palabras->fetch_assoc();                            
                    ?>
                    <li id="<?php echo $fila['id'];?>" class="list-group-item" onclick="mostrarinfo('<?php echo $fila['definicion']?>')">  
                    <h1>
                    <?php
                        echo $fila['nombre'];    
...
<script type="text/javascript">
    ...
    function mostrarinfo(definicion){
      console.log(definicion)
        Swal.fire(definicion)
