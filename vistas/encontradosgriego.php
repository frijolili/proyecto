...
$clasico = new clasico();
$clas = $clasico->comprobar($_POST['atr']);
        ...
        <hr>
           <div class="position-absolute mt-1 start-50 translate-middle-x">
            <ul class="list-group list-group-flush">                              
                    ...
                    ?>
                    <li id="<?php echo $clas[$i]['idgen'];?>" class="list-group-item">  
                    <h1>
                    <a href="clasico.php?id=<?php echo $clas[$i]['idgen'];?>" style="color: black; text-decoration:none;"> 
                            <?php
                                 echo $clas[$i]['nombre'];                         
